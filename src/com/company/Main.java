...
public class Main {
    ...
    public static void printTuesdays(List<Entry> entries) {
        ...
        entries.stream()
                ...
                .forEach(entry -> System.out.println(Day.TUESDAY));
        // write stream
        System.out.println();
    }
    ...
    public static void countTueWedThur(List<Entry> entries) {
        ...
        // write for loop
        for(Entry entry: entries) {
            System.out.println(entry -> System.out.println(count + ", "));
        }
        ...
        // write stream
        entries.stream()
                .count(entry -> getDay().equals(Day.TUESDAY, Day.WEDNESDAY, Day.THURSDAY))
                .forEach(entr -> System.out.println());
